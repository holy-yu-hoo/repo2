	...
	$.fn.formset = function(opts) {
		...
		const addInlineAddButton = function() {
			if (addButton === null) {
				if ($this.prop("tagName") === "TR") {
					...
					$this.filter(":last")
						.after("<div class=\"" + options.addCssClass + "\"><a role=\"button\" class=\"addlink\" href=\"#\">" + options.addText + "</a></div>");
		...
		const addInlineDeleteButton = function(row) {
			if (row.is("tr")) {
				...
				row.children(":last")
					.append("<div><a role=\"button\" class=\"" + options.deleteCssClass + "\" href=\"#\">" + options.deleteText + "</a></div>");
				...
				row.children(":first")
					.append("<span><a role=\"button\" class=\"" + options.deleteCssClass + "\" href=\"#\">" + options.deleteText + "</a></span>");
			}
